...
public class TelaAlterarProfessor extends javax.swing.JFrame {
    ...
    public TelaAlterarProfessor(UsuarioModel professor) {
    ...
    private void preencherCampos() {
        ...
        jCalendarComboBoxDataN.setDate(professor.getDataNascimento());
    }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jPasswordFieldConfirmaSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 309, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addContainerGap()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jCalendarComboBoxDataN, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(122, 122, 122)
                                .addComponent(Salvar))
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TelaAlterarProfessor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void SalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalvarActionPerformed
        ...
        try{
            usuarioController.atualizarUsuario(professor);
        }catch(Exception e){
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (confirmacao == JOptionPane.YES_OPTION) {
            try {
                usuarioController.excluirUsuario(professor.getId());
